...
import { FinalCompressedId, IdCreationRange, IIdCompressor, IIdCompressorCore, OpSpaceCompressedId, SerializedIdCompressor, SerializedIdCompressorWithNoSession, SerializedIdCompressorWithOngoingSession, SessionId, SessionSpaceCompressedId, StableId } from "./types";
...
export class IdCompressor implements IIdCompressor, IIdCompressorCore {
    ...
    normalizeToSessionSpace(id: OpSpaceCompressedId, sessionIdIfLocal?: SessionId | undefined): SessionSpaceCompressedId;
    normalizeToSessionSpace(id: unknown, sessionIdIfLocal?: unknown): import("./types").SessionSpaceCompressedId {
        throw new Error("Method not implemented.");
    }
    ...
    serialize(withSession: unknown): import("./types").SerializedIdCompressorWithOngoingSession | import("./types").SerializedIdCompressor | import("./types").SerializedIdCompressorWithNoSession {
        throw new Error("Method not implemented.");
    }
}